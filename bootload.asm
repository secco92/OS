...
; Values are used by IBM for 1.44 MB, 3.5" diskette
...
read_fat_ok:
	...
	mov ax, 100h									; Segment where we'll load the kernel
	mov es, ax
	mov bx, 0
...
load_file_sector:
	...
	mov ax, 100h									; Set buffer past what we've already read
	mov es, ax
	mov bx, word [pointer]
...
next_cluster_cont:
	...
	jmp 100h:0000h								; Jump to entry point of loaded kernel!
